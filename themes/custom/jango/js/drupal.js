  ...
  Drupal.behaviors.theme_styles = {
    attach: function (context, settings) {
      $('.c-settings .c-color', context).on('click', function () {
        ...
        $('body')
          .append('<link href="' + Drupal.settings.base_path + Drupal.settings.theme_path + '/assets/base/css/themes/' + val + '.css" rel="stylesheet" id="nd_style_theme" type="text/css">');
...
//              timeout: 5000
              ...
              .done(function (result) {
                t.updateSinglePageInline($(result).find('.node-nd-project').closest('#content').html());
              })
              .fail(function () {
