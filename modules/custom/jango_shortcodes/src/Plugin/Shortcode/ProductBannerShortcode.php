...
class ProductBannerShortcode extends ShortcodeBase {
  ...
  public function process($attrs, $text, $langcode = Language::LANGCODE_NOT_SPECIFIED) {
    ...
    $filename = isset($attrs['fid']) && !empty($attrs['fid']) ? file_create_url(File::load($attrs['fid'])->getFileUri()) : '';
  ...
  public function settings($attrs, $text, $langcode = Language::LANGCODE_NOT_SPECIFIED) {
    ...
    $form['fid'] = [
      ...
      '#field_suffix' => '<div class="preview-image"></div><a href="#" class="media-upload button">' . t('Upload Image') . '</a><a href="#" class="media-remove button">' . t('Remove Image') . '</a>',
      '#prefix' => '<div class="row"><div class = "col-sm-4">',
      '#suffix' => '</div>',
    ];
